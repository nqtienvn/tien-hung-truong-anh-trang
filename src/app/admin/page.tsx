...
const DOOR_CONFIGS = [
  ...
  { doorId: 'door-room4', targetRoom: 'gallery-subsidy', label: 'Phòng 04: Hoàn thành', color: 'rose' },
];
          ...
          <div className="p-4 flex flex-col space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3">
              {[
                ...
                // Ràng buộc tắt phòng: Các cửa liên quan phải đóng
                const relatedDoors = room.id === 'gallery-subsidy'
                  ? ['door-room1', 'door-room2', 'door-room4']
            ...
            <div className="grid grid-cols-1 gap-3">
              {DOOR_CONFIGS.map((config) => {
                ...
                if (config.doorId === 'door-room1') {
                  ...
                  isPrereqMet = roomStates['gallery-sculptures']?.isOpen || false;
                }
