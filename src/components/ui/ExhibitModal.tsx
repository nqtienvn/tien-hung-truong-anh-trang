...
import { X, Play, Pause, Globe, User, BookOpen, Volume2, HelpCircle, Check, AlertTriangle, ArrowRight, Save, Clock } from 'lucide-react';
        ...
        <div className="flex-1 p-6 lg:p-8 overflow-y-auto space-y-6 custom-scrollbar text-base min-w-0">
          ...
          {isSubsidyRoom && gameData ? (
            ...
            <>
              {/* Tiêu đề & Tác giả */}
              <div>
                <h2 className="text-xl font-bold tracking-tight text-white leading-tight mb-1 font-serif">
                  {titleText}
                </h2>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-slate-350 leading-relaxed font-sans text-justify bg-slate-900/20 p-3 rounded-xl border border-slate-900">
                  {descriptionText}
                </p>
              </div>
